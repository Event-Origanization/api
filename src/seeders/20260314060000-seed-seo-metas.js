...
module.exports = {
  async up(queryInterface, Sequelize) {
    ...
    const metas = [
      ...
      {
        page_key: 'EVENT_VIDEO',
        title_vi: 'Video sự kiện | 5P Event',
        title_en: 'Event Videos | 5P Event',
        title_zh: '活动视频 | 5P Event',
        description_vi: 'Dịch vụ tổ chức sự kiện chuyên nghiệp, video highlight sự kiện của 5P Event.',
        description_en: 'Professional event organization services, event highlight videos by 5P Event.',
        description_zh: '5P Event 提供专业、创意的活动策划服务，活动精彩视频。',
        path: '/video-su-kien',
        created_at: new Date(),
        updated_at: new Date()
      },
      {
        page_key: 'EVENT_IMAGE',
        title_vi: 'Hình ảnh sự kiện | 5P Event',
        title_en: 'Event Images | 5P Event',
        title_zh: '活动图片 | 5P Event',
        description_vi: 'Hình ảnh các dự án sự kiện tiêu biểu đã thực hiện bởi 5P Event.',
        description_en: 'Images of typical event projects implemented by 5P Event.',
        description_zh: '5P Event 执行的典型活动项目图片。',
      ...
      },
      {
        ...
        title_vi: 'SEVEN LIGHTING & SOUND | Âm thanh ánh sáng chuyên nghiệp',
        title_en: 'SEVEN LIGHTING & SOUND | Professional Sound & Lighting',
        title_zh: 'SEVEN LIGHTING & SOUND | 专业音响灯光',
        description_vi: 'SEVEN LIGHTING & SOUND cung cấp hệ thống âm thanh ánh sáng màn hình LED chuyên nghiệp cho mọi sự kiện.',
        description_en: 'SEVEN LIGHTING & SOUND provides professional sound, lighting, and LED screen systems for all events.',
        description_zh: 'SEVEN LIGHTING & SOUND 为所有活动提供专业的音响、灯光和 LED 屏幕系统。',
        path: '/sound-lighting',
        created_at: new Date(),
        updated_at: new Date()
      },
