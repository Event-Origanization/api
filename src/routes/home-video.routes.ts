...
// Admin only routes
router.post(HOME_VIDEO_ROUTES.CREATE, authenticateToken, requireAdmin, HomeVideoController.createHomeVideo);
router.put(HOME_VIDEO_ROUTES.UPDATE, authenticateToken, requireAdmin, HomeVideoController.updateHomeVideo);
